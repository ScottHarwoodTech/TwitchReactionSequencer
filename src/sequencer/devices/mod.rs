...
pub async fn setup_devices() -> Result<HashMap<&'static str, Box<dyn DeviceTrait>>, Box<dyn Error>>
{
    let device_set: HashMap<&'static str, Box<dyn DeviceTrait>> = HashMap::new();
