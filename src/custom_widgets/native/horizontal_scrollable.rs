...
pub mod style {
    //! The styles of a [`HorizontalScrollable`].
    //!
    //! [`HorizontalScrollable`]: iced_native::widget::HorizontalScrollable
...
pub struct HorizontalScrollable<'a, Message, Renderer>
where
...
impl<'a, Message, Renderer> HorizontalScrollable<'a, Message, Renderer>
where
    Renderer: iced_native::Renderer,
    Renderer::Theme: StyleSheet,
{
    /// Creates a new [`HorizontalScrollable`] with the given [`State`].
    ...
    /// Sets the [`Padding`] of the [`HorizontalScrollable`].
    pub fn padding<P: Into<Padding>>(mut self, padding: P) -> Self {
        self.content = self.content.padding(padding);
        self
    }

    /// Sets the width of the [`HorizontalScrollable`].
    pub fn width(mut self, width: Length) -> Self {
        self.content = self.content.width(width);
        self
    }

    /// Sets the height of the [`HorizontalScrollable`].
    pub fn height(mut self, height: Length) -> Self {
        self.height = height;
        self
    }

    /// Sets the maximum width of the [`HorizontalScrollable`].
    pub fn max_width(mut self, max_width: u32) -> Self {
        self.content = self.content.max_width(max_width);
        self
    }

    /// Sets the maximum height of the [`HorizontalScrollable`] in pixels.
    pub fn max_height(mut self, max_height: u32) -> Self {
        self.max_height = max_height;
        self
    }

    /// Sets the horizontal alignment of the contents of the [`HorizontalScrollable`] .
    ...
    /// Sets the scrollbar margin of the [`HorizontalScrollable`] .
    pub fn scrollbar_margin(mut self, scrollbar_margin: u16) -> Self {
        self.scrollbar_margin = scrollbar_margin;
        self
    }

    /// Sets the scroller width of the [`HorizontalScrollable`] .
    ///
    ...
    /// Sets a function to call when the [`HorizontalScrollable`] is scrolled.
    ///
    /// The function takes the new relative offset of the [`HorizontalScrollable`]
    ...
    /// Sets the style of the [`HorizontalScrollable`] .
    pub fn style(mut self, style: impl Into<<Renderer::Theme as StyleSheet>::Style>) -> Self {
        self.style = style.into();
        self
    }

    /// Adds an element to the [`HorizontalScrollable`].
...
/// Computes the layout of a [`HorizontalScrollable`].
...
/// Processes an [`Event`] and updates the [`State`] of a [`HorizontalScrollable`]
/// accordingly.
...
/// Computes the current [`mouse::Interaction`] of a [`HorizontalScrollable`].
...
impl<'a, Message, Renderer> Widget<Message, Renderer>
    for HorizontalScrollable<'a, Message, Renderer>
where
    Renderer: iced_native::Renderer,
    Renderer::Theme: StyleSheet,
{
    ...
    fn draw(
        ...
        draw(
            ...
            |renderer, layout, cursor_position, viewport| {
                self.content
                    .draw(renderer, theme, style, layout, cursor_position, viewport)
            },
        )
    }
...
/// The local state of a [`HorizontalScrollable`].
...
impl State {
    ...
    /// the [`HorizontalScrollable`] and its contents.
    ...
    /// Scrolls the [`HorizontalScrollable`] to a relative amount.
    ///
    ...
    /// [`HorizontalScrollable`] and its contents.
    ...
    /// of the [`HorizontalScrollable`] and its contents.
...
/// The scrollbar of a [`HorizontalScrollable`].
#[derive(Debug)]
struct Scrollbar {
...
impl<'a, Message, Renderer> From<HorizontalScrollable<'a, Message, Renderer>>
...
{
    fn from(
        scrollable: HorizontalScrollable<'a, Message, Renderer>,
